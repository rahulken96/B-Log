...
<head>
  ...
  <title>Dashboard Blog | VSGA Project</title>
...
<body>
    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2">
          <a href="functions/tambah-blog.php" class="btn btn-info btn-sm text-dark">Tambah Data</a>
        </div>
        <div class="justify-content-between align-items-center pt-3 pb-2">
          <table id="blog" class="table table-responsive table-striped">
            <thead>
              <tr>
                <th width="2%">No. </th>
  ...
  <script>
    function hapus(id) {
      ...
      if (hapus) {
        document.location.href = `functions/hapus-blog.php?id=${id}`;
      }
    }
