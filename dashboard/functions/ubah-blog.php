...
<body>
  ...
  <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="../../index.php">B-Log</a>
  </header>
    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2">
          <a href="../blog.php" class="btn btn-warning btn-sm text-dark"><i class="bi bi-arrow-left-circle"></i> Kembali</a>
        </div>
        <div class="container mt-4">
          <form class="row g-3" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" placeholder="Masukkan sub-judul" id="subJudul" name="subJudul" value="<?= $blog[0]['sub_judul'] ?>" required />
            </div>
            <div class="col-12">
              ...
              <select id="tipe" name="tipe" class="form-select" required>
                ...
                <?php foreach($kategori as $item): ?>
                  <option value="<?= $item['kategori'] ?>" <?= $blog[0]['tipe'] == $item['kategori'] ? 'selected' : '' ?>><?= $item['kategori'] ?></option>
                <?php endforeach ?>
              </select>
            </div>
            <div class="col-12">
              <label for="desk" class="form-label">Deskripsi Blog</label>
              <textarea class="form-control" placeholder="Tuliskan deskripsi..." id="desk" name="desk" required><?= $blog[0]['deskripsi'] ?></textarea>
            </div>
            <div class="col-md-12">
              <label for="gambar" class="form-label">Gambar Blog</label><br>
              <img src="../../upload/<?= $blog[0]['gambar'] ?>" alt="Gambar Post" srcset="Gambar Post" height="250px" class="mb-2">
              <input class="form-control" type="file" id="gambar" name="gambar">
            </div>
            <div class="col-12 mb-5">
              <button type="submit" class="btn btn-success" name="ubah">Ubah Postingan</button>
            </div>
          </form>
        </div>
      </main>
